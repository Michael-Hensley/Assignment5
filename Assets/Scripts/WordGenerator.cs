...
public class WordGenerator : MonoBehaviour {
	...
	private static string[] wordList = {   "sidewalk", "A+", "robin", "three", "protect", "periodic",
									...
									"guide", "long", "chief", "mom","B-", "signal", "rely", "abortive",
									...
									"ablaze", "thoughtless", "love", "verdict", "giant", "O-"   };
